...
Väčšina parsovacích nástrojov pre bezkontextové gramatiky, ktoré podporujú Javu, používa parsovacie algoritmy typu LL a LR. Z tohto dôvodu sa ďalej budeme venovať práve týmto typom algoritmov.
