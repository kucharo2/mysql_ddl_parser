...
public final class PgProto {
  ...
  public static final class TypeInfo extends
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (((bitField0_ & 0x00000001) == 0x00000001)) {
        output.writeBytes(1, getModifierBytes());
      }
      if (((bitField0_ & 0x00000002) == 0x00000002)) {
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000001) == 0x00000001)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(1, getModifierBytes());
      }
      if (((bitField0_ & 0x00000002) == 0x00000002)) {
        size += com.google.protobuf.CodedOutputStream
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 58: {
              ...
              newTypeinfo_.add(input.readMessage(io.debezium.connector.postgresql.proto.PgProto.TypeInfo.PARSER, extensionRegistry));
              break;
            }
          }
        }
  ...
  bitField0_ |= 0x00000004;
      ...
      private com.google.protobuf.RepeatedFieldBuilder<
          ...
          getNewTypeinfoFieldBuilder() {
        if (newTypeinfoBuilder_ == null) {
          newTypeinfoBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<
              io.debezium.connector.postgresql.proto.PgProto.TypeInfo, io.debezium.connector.postgresql.proto.PgProto.TypeInfo.Builder, io.debezium.connector.postgresql.proto.PgProto.TypeInfoOrBuilder>(
                  newTypeinfo_,
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "s.PointH\000B\007\n\005datum\"4\n\010TypeInfo\022\020\n\010modifi" +
      "er\030\001 \002(\t\022\026\n\016value_optional\030\002 \002(\010\"\356\001\n\nRow",
      "Message\022\026\n\016transaction_id\030\001 \001(\r\022\023\n\013commi" +
      "t_time\030\002 \001(\004\022\r\n\005table\030\003 \001(\t\022\033\n\002op\030\004 \001(\0162" +
      "\017.decoderbufs.Op\022,\n\tnew_tuple\030\005 \003(\0132\031.de" +
      "coderbufs.DatumMessage\022,\n\told_tuple\030\006 \003(" +
      "\0132\031.decoderbufs.DatumMessage\022+\n\014new_type" +
      "info\030\007 \003(\0132\025.decoderbufs.TypeInfo*(\n\002Op\022" +
      "\n\n\006INSERT\020\000\022\n\n\006UPDATE\020\001\022\n\n\006DELETE\020\002B3\n&i" +
      "o.debezium.connector.postgresql.protoB\007P" +
      "gProtoH\001"
    };
